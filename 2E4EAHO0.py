...
# output_filename = os.path.join(rdf_data_files, file_key) + '.rdf'
output_filename = file_key + '.rdf'

data_file_names = []
for data_file_name in os.listdir(csv_data_files):
    if data_file_name.startswith(file_key) and data_file_name.endswith('.csv'):
        data_file_names.append(data_file_name)

lines = []
for data_file_name in data_file_names:
    input_filename = os.path.join(csv_data_files, data_file_name)
...
# pprint.pprint(crops_to_uri_table)
# pprint.pprint(crops_uri_to_nodes_table)
